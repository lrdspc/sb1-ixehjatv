...
const CustomLogin: React.FC = () => {
  ...
  const handleEmailSubmit = async (e: React.FormEvent) => {
    ...
    try {
      // Iniciar o processo de login com email
      const signInAttempt = await clerk.client.signIn.create({
        identifier: email,
        strategy: 'email_code',
      });
      
      // Armazenar o ID da tentativa de login para uso posterior
      setVerificationId(signInAttempt.id);
    ...
    <div className="min-h-screen bg-gray-50 flex flex-col justify-center py-12 sm:px-6 lg:px-8">
      <div className="sm:mx-auto sm:w-full sm:max-w-md">
        ...
        <h2 className="mt-6 text-center text-3xl font-extrabold text-gray-900">
          {step === 'email' ? 'Entrar na sua conta' : 'Verificar seu email'}
        </h2>
